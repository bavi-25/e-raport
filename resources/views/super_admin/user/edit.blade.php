...
@section('title', 'E-Raport | Edit User')
@section('content')
<div class="row">
    <div class="col-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                    name="name" placeholder="ex: John Doe" value="{{ old('name', $user->name) }}"
                                    required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nip_nis') is-invalid @enderror"
                                    id="nip_nis" name="nip_nis" placeholder="ex: 12345678"
                                    value="{{ old('nip_nis', $user->profile->nip_nis ?? '') }}" required>
                                @error('nip_nis')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                    name="email" placeholder="ex: jhondoe@example.com"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone"
                                    name="phone" placeholder="ex: 08123456789"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('birthdate') is-invalid @enderror"
                                    ...
                                    value="{{ old('birthdate', $user->profile->birth_date ?? '') }}" required>
                                @error('birthdate')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="religion" name="religion"
                                    ...
                                    <option value="" disabled
                                        {{ old('religion', $user->profile->religion ?? null) ? '' : 'selected' }}>
                                        - Select Religion -
                                    </option>
                                    @foreach ($religions as $religion)
                                    <option value="{{ $religion }}"
                                        {{ old('religion', $user->profile->religion ?? null) == $religion ? 'selected' : '' }}>
                                        {{ $religion }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="gender" name="gender"
                                    ...
                                    <option value="" disabled
                                        {{ old('gender', $user->profile->gender ?? null) ? '' : 'selected' }}>
                                        - Select Gender -
                                    </option>
                                    @foreach ($genders as $gender)
                                    <option value="{{ $gender }}"
                                        {{ old('gender', $user->profile->gender ?? null) == $gender ? 'selected' : '' }}>
                                        {{ $gender }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select id="tenant" name="tenant"
                                    ...
                                    <option value="" disabled {{ old('tenant', $user->tenant_id) ? '' : 'selected' }}>
                                        - Select Tenant -
                                    </option>
                                    @foreach ($tenants as $tenant)
                                    <option value="{{ $tenant->id }}"
                                        {{ (string) old('tenant', $user->tenant_id) === (string) $tenant->id ? 'selected' : '' }}>
