...
@section('title', 'E-Raport | Edit Subject')

@section('content')
<div class="row">
    <div class="col-12">
        <form method="POST" action="{{ route('school.subjects.update', $subject->id) }}">
            @csrf
            @method('PUT')
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="group_name" name="group_name"
                                    value="{{ old('group_name', $subject->group_name) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="phase" name="phase" value="{{ old('phase', $subject->phase) }}"
