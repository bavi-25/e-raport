...
@section('title', 'E-Raport | Create Assessment')

@section('content')
<div class="row">
    <div class="col-12">
        <form method="POST" action="{{ route('school.assessments.store') }}">
            @csrf
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Assessment</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="date" name="date" value="{{ old('date', $today) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="class_subject_id" name="class_subject_id"
                                    ...
                                    @endphp
                                    <option value="{{ $cs->id }}"
                                        {{ old('class_subject_id') == $cs->id ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="assessment_component_id" name="assessment_component_id"
                                    ...
                                    <option value="{{ $c->id }}"
                                        {{ old('assessment_component_id') == $c->id ? 'selected' : '' }}>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover mb-0" id="itemsTable">
                            ...
                            <tbody id="itemsBody">
                                ...
                                {{-- Render old inputs after validation fail --}}
                                ...
                                @endforeach
                                @else
                                {{-- Default satu baris awal kalau belum ada old input --}}
                                <tr>
                                    <td class="align-middle index-col"></td>
                                    <td>
...
<script>
    ...
    // Tentukan index berikutnya dari baris yang ada (berdasarkan name[])
    ...
    function createRow(idx, data = { competency_code: '', max_score: '' }) {
    ...
    // Init: hitung total awal & nomor urut
    renumberRows();
    recalcTotal();

    // Delegasi: remove row + perhitungan total realtime
    ...
    // Clear semua baris -> sisakan 1 baris kosong
    btnClear.addEventListener('click', function () {
        itemsBody.innerHTML = '';
        addItemRow();
    });

    // Validasi sederhana sebelum submit: minimal 1 baris dan semua required terisi
    document.querySelector('form').addEventListener('submit', function (e) {
        ...
        if (!ok) {
            e.preventDefault();
            alert('Lengkapi semua kolom pada Assessment Items.');
        }
    });
});
</script>
