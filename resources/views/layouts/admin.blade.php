                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="/dashboard"
                                    ...
                                    <svg class="nav-icon" viewBox="0 0 32 32" fill="currentColor" width="20" height="20"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('school.class_rooms.index') }}"
                                    ...
                                    <svg class="nav-icon" width="20" height="20" viewBox="0 0 512.001 512.001"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('school.students.index') }}"
                                    ...
                                    <svg class="nav-icon" width="20" height="20" viewBox="0 0 31.283 31.284"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('school.grade_entries.index') }}"
                                    ...
                                    <i class="nav-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1800 1800" class="icon-svg" width="20" height="20"
                                            fill="currentColor">
                                            <g>
                                                <path d="M241.023,324.818c0.252,0,0.505,0.035,0.758,0.035h465.68c17.266,0,31.256-13.99,31.256-31.252
                                                ...
                                                <path d="M210.529,450.306c0,17.257,13.994,31.252,31.252,31.252h769.451c17.262,0,31.256-13.995,31.256-31.252
                                                c0-17.266-13.994-31.252-31.256-31.252H241.781C224.523,419.054,210.529,433.04,210.529,450.306z" />
                                                <path d="M1011.232,575.751H241.781c-8.149,0-15.549,3.147-21.116,8.261c-6.213,5.712-10.136,13.879-10.136,22.987
                                                ...
                                                <path d="M1011.232,889.157H241.781c-8.149,0-15.549,3.147-21.116,8.261c-6.213,5.713-10.136,13.879-10.136,22.987
                                                ...
                                                <path d="M1011.232,1359.273H241.781c-8.149,0-15.549,3.151-21.116,8.265c-6.213,5.713-10.136,13.875-10.136,22.987
                                                ...
                                                <path d="M1233.542,251.228l-49.851-45.109L1052.136,87.076l-59.185-53.554c-5.293-4.792-11.947-7.421-18.786-7.836
                                                ...
                                                <path d="M1798.578,180.737c-7.049-88.305-81.114-158.02-171.205-158.02c-0.004,0-0.004,0-0.004,0
