    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            <span class="info-box-icon bg-danger elevation-1">
                ...
                <svg viewBox="0 0 490 490" width="45" height="45" fill="currentColor" aria-label="Teacher icon"
                    focusable="false">
                    <g>
                        <g>
                  ...
                  s6.967-3.119,6.967-6.967v-10.187h10.182c3.848,0,6.967-3.119,6.967-6.966C132.572,95.53,129.453,92.411,125.605,92.411z" />
                            <g>
                                <g>
                                    <path d="M247.795,115.696h-39.296c-3.847,0-6.966-3.118-6.966-6.966c0-3.847,3.119-6.966,6.966-6.966h39.296
                      c3.848,0,6.967,3.119,6.967,6.966C254.762,112.578,251.643,115.696,247.795,115.696z" />
                                </g>
                                <g>
                                    <path d="M247.795,135.712h-39.296c-3.847,0-6.966-3.119-6.966-6.967c0-3.848,3.119-6.967,6.966-6.967h39.296
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">1180</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
